...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final boolean[]AreaPicked={true,true,true,true,true,true,true,true,true,true};
        //設立點擊事件(地區)
        img_area.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                builder.setMultiChoiceItems(area_list,AreaPicked, new DialogInterface.OnMultiChoiceClickListener() {
                    //預設checkitem是null,可以餵Boolean陣列控制勾選情形
                    @Override
                    public void onClick(DialogInterface dialog, int which, boolean isChecked) {
                        if (isChecked){
                            match =match+area_list[which];
                            AreaPicked[which]=true;
